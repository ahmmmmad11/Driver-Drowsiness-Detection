...
## Citation
This code has been copied from https://github.com/mohitwildbeast/Driver-Drowsiness-Detector.git for the purpose of training and learning I'm not the one who wrote  the code, just i made a bit of change.
